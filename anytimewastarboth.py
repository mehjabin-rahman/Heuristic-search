...
def anytime_weighted_astarb(start, goal, map, heuristic_weight, movement_cost=1):
    expand=0
        ...
        try:
            ...
            for neighbor in neighbors:
                ...
                if(neighbor_node == goal_node):
                    ...
                    #print("c",closed_list)
                    #print("i",inconsistent_list)
                    for i in list(inconsistent_list):
                        #print(i)
                        open_list.anytime_insert(inconsistent_list.pop(i))
                    #time.sleep(0.5)
                ...
                if (output[0]):
                    ...
                    if ((neighbor_node < node)[0]):
                        inconsistent_list[hash(neighbor_node.state)] = neighbor_node
