...
if __name__ == '__main__':
    ...
    for x in range(0, 200):
        ...
        '''
        timer_start = time.time()
        anytimewastar_outputrw = anytime_weighted_astarw(start, goal, map, hueristic_weight)
        timer_stop = time.time()
        AWAW = timer_stop - timer_start

        timer_start = time.time()
        anytimewastar_outputre = anytime_weighted_astar(start, goal, map, hueristic_weight)
        timer_stop = time.time()
        AWAR = timer_stop - timer_start
